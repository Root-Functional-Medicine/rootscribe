...
// NOTE: RecordingDetail + InboxMutationResponse builders used to live here as
// `makeRecordingDetail` / `makeInboxMutationResponse`. Per DEVX-104 those
// shapes moved to Fishery factories in `@rootscribe/shared/test-factories`
// (`recordingDetailFactory` and `inboxMutationResponseFactory`). This module
// now only owns render-infrastructure helpers — provider wiring, fetch
// stubbing, JSON response construction — not data-shape builders.
