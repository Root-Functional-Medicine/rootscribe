...
**macOS / Linux / WSL:**
```bash
curl -fsSL https://raw.githubusercontent.com/rsteckler/applaud/v0.5.5/install.sh | sh
```

**Windows (PowerShell):**
```powershell
irm https://raw.githubusercontent.com/rsteckler/applaud/v0.5.5/install.ps1 | iex
```
